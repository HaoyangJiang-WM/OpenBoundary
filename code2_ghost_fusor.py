...
class STGNN_AR_GhostFusor(nn.Module):
    ...
    def forward(self, data, y_target=None, teacher_forcing_ratio=0.0, boundary_tf_ratio=0.0):
        ...
        for t in range(self.Tout):
            ...
            if bnd.numel() > 0:
                # boundary teacher forcing 只影响 down_feat
            ...
            # 极简 ghost：用 |nxt| 的能量当 strength（你想换成 PDE residual 也很容易）
...
if __name__ == "__main__":
    hparams = {
        "seed": 42,
        "use_cuda": True,
        "save_path": "runs_code2_ghost_fusor",
        "data": {
            "path": "./LamaH-CE",
